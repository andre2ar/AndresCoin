...
def valid_proof(transactions, last_hash, proof):
    ...
    # Only a hash (which is based on the above inputs) which starts with two 0s is treated as valid This condition is
    # of course defined by you. You could also require 10 leading 0s - this would take significantly longer (and this
